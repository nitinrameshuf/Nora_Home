...
- [`docs/Main_App/who-found-what.md`](docs/Main_App/who-found-what.md) — every
  bug and invented rule in this project, sorted by whether **the user, an agent,
  or QA** caught it. Read it before trusting your own review of your own work.
